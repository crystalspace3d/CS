...
class csStringSet(object):
    ...
    __del__ = lambda self : None;
    def assign(self, *args): return _core.csStringSet_assign(self, *args)
    def Request(self, *args): return _core.csStringSet_Request(self, *args)
    def Contains(self, *args): return _core.csStringSet_Contains(self, *args)
    def Delete(self, *args): return _core.csStringSet_Delete(self, *args)
    def Empty(self): return _core.csStringSet_Empty(self)
    def GetSize(self): return _core.csStringSet_GetSize(self)
    def IsEmpty(self): return _core.csStringSet_IsEmpty(self)
    def Clear (*args):
...
class iFile(iBase):
    ...
    def GetAllData(self, nullterm = False): return _core.iFile_GetAllData(self, nullterm)
...
class iStringSet(iBase):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    def Request(self, *args): return _core.iStringSet_Request(self, *args)
    def Contains(self, *args): return _core.iStringSet_Contains(self, *args)
    def Delete(self, *args): return _core.iStringSet_Delete(self, *args)
    def Empty(self): return _core.iStringSet_Empty(self)
    def Clear(self): return _core.iStringSet_Clear(self)
    def GetSize(self): return _core.iStringSet_GetSize(self)
    def IsEmpty(self): return _core.iStringSet_IsEmpty(self)
...
def csHashCompute(*args):
  return _core.csHashCompute(*args)
...
def csevPreProcess(*args):
  return _core.csevPreProcess(*args)
csevPreProcess = _core.csevPreProcess

def csevProcess(*args):
  return _core.csevProcess(*args)
csevProcess = _core.csevProcess

def csevPostProcess(*args):
  return _core.csevPostProcess(*args)
csevPostProcess = _core.csevPostProcess

def csevFinalProcess(*args):
  return _core.csevFinalProcess(*args)
