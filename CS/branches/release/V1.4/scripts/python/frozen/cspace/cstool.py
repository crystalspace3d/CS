...
class csColliderActor(object):
    ...
    def CheckRevertMove(self): return _cstool.csColliderActor_CheckRevertMove(self)
...
class iPen(object):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    def SetFlag(self, *args): return _cstool.iPen_SetFlag(self, *args)
    def ClearFlag(self, *args): return _cstool.iPen_ClearFlag(self, *args)
    def SetMixMode(self, *args): return _cstool.iPen_SetMixMode(self, *args)
    def SetColor(self, *args): return _cstool.iPen_SetColor(self, *args)
    def SetTexture(self, *args): return _cstool.iPen_SetTexture(self, *args)
    def SwapColors(self): return _cstool.iPen_SwapColors(self)
    def SetPenWidth(self, *args): return _cstool.iPen_SetPenWidth(self, *args)
    def ClearTransform(self): return _cstool.iPen_ClearTransform(self)
    def PushTransform(self): return _cstool.iPen_PushTransform(self)
    def PopTransform(self): return _cstool.iPen_PopTransform(self)
    def SetOrigin(self, *args): return _cstool.iPen_SetOrigin(self, *args)
    def Translate(self, *args): return _cstool.iPen_Translate(self, *args)
    def DrawLine(self, *args): return _cstool.iPen_DrawLine(self, *args)
    def DrawPoint(self, *args): return _cstool.iPen_DrawPoint(self, *args)
    def DrawRect(self, *args): return _cstool.iPen_DrawRect(self, *args)
    def DrawMiteredRect(self, *args): return _cstool.iPen_DrawMiteredRect(self, *args)
    def DrawRoundedRect(self, *args): return _cstool.iPen_DrawRoundedRect(self, *args)
    def DrawArc(self, *args): return _cstool.iPen_DrawArc(self, *args)
    def DrawTriangle(self, *args): return _cstool.iPen_DrawTriangle(self, *args)
    def Write(self, *args): return _cstool.iPen_Write(self, *args)
    def WriteBoxed(self, *args): return _cstool.iPen_WriteBoxed(self, *args)
    def _Rotate(self, *args): return _cstool.iPen__Rotate(self, *args)
    def Rotate(self,a):
...
class csMemoryPen(iPen):
    ...
    __repr__ = _swig_repr
    def __init__(self): 
        this = _cstool.new_csMemoryPen()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _cstool.delete_csMemoryPen
    __del__ = lambda self : None;
    def Clear(self): return _cstool.csMemoryPen_Clear(self)
    def Draw(self, *args): return _cstool.csMemoryPen_Draw(self, *args)
    def SetFlag(self, *args): return _cstool.csMemoryPen_SetFlag(self, *args)
    def ClearFlag(self, *args): return _cstool.csMemoryPen_ClearFlag(self, *args)
    def SetMixMode(self, *args): return _cstool.csMemoryPen_SetMixMode(self, *args)
    def SetColor(self, *args): return _cstool.csMemoryPen_SetColor(self, *args)
    def SetTexture(self, *args): return _cstool.csMemoryPen_SetTexture(self, *args)
    def SwapColors(self): return _cstool.csMemoryPen_SwapColors(self)
    def SetPenWidth(self, *args): return _cstool.csMemoryPen_SetPenWidth(self, *args)
    def ClearTransform(self): return _cstool.csMemoryPen_ClearTransform(self)
    def PushTransform(self): return _cstool.csMemoryPen_PushTransform(self)
    def PopTransform(self): return _cstool.csMemoryPen_PopTransform(self)
    def SetOrigin(self, *args): return _cstool.csMemoryPen_SetOrigin(self, *args)
    def Translate(self, *args): return _cstool.csMemoryPen_Translate(self, *args)
    def DrawLine(self, *args): return _cstool.csMemoryPen_DrawLine(self, *args)
    def DrawPoint(self, *args): return _cstool.csMemoryPen_DrawPoint(self, *args)
    def DrawRect(self, *args): return _cstool.csMemoryPen_DrawRect(self, *args)
    def DrawMiteredRect(self, *args): return _cstool.csMemoryPen_DrawMiteredRect(self, *args)
    def DrawRoundedRect(self, *args): return _cstool.csMemoryPen_DrawRoundedRect(self, *args)
    def DrawArc(self, *args): return _cstool.csMemoryPen_DrawArc(self, *args)
    def DrawTriangle(self, *args): return _cstool.csMemoryPen_DrawTriangle(self, *args)
    def Write(self, *args): return _cstool.csMemoryPen_Write(self, *args)
    def WriteBoxed(self, *args): return _cstool.csMemoryPen_WriteBoxed(self, *args)
