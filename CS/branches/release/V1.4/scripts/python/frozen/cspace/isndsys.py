...
class iSndSysSourceSoftware3D(iSndSysSourceSoftware):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    def SetPosition(self, *args): return _isndsys.iSndSysSourceSoftware3D_SetPosition(self, *args)
    def GetPosition(self): return _isndsys.iSndSysSourceSoftware3D_GetPosition(self)
    def SetDirection(self, *args): return _isndsys.iSndSysSourceSoftware3D_SetDirection(self, *args)
    def GetDirection(self): return _isndsys.iSndSysSourceSoftware3D_GetDirection(self)
    def SetDirectionalRadiation(self, *args): return _isndsys.iSndSysSourceSoftware3D_SetDirectionalRadiation(self, *args)
    def GetDirectionalRadiation(self): return _isndsys.iSndSysSourceSoftware3D_GetDirectionalRadiation(self)
    def SetMinimumDistance(self, *args): return _isndsys.iSndSysSourceSoftware3D_SetMinimumDistance(self, *args)
    def SetMaximumDistance(self, *args): return _isndsys.iSndSysSourceSoftware3D_SetMaximumDistance(self, *args)
    def GetMinimumDistance(self): return _isndsys.iSndSysSourceSoftware3D_GetMinimumDistance(self)
    def GetMaximumDistance(self): return _isndsys.iSndSysSourceSoftware3D_GetMaximumDistance(self)
