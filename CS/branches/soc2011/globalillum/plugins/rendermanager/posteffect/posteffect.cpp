...
void PostEffect::DimensionData::AllocatePingpongTextures (PostEffect& pfx)
{
...
//---------------------------------------------------------------------------
// TO be put in a separate loader
/*
namespace
{
                                         ...
                                         ShadersLayers& shaders)
{
  ...
  PostEffect::LayerOptions layerOpts;
  ...
  csDirtyAccessArray<PostEffect::LayerInputMap> inputs;
