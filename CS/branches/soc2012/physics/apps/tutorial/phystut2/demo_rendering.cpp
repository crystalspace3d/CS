  ...
  case CAMERA_DYNAMIC:
    {
      ...
      {
        csRef<CS::Collisions::iCollider> sphere = collisionSystem->CreateColliderSphere (ActorDimensions.x);
  ...
  case CAMERA_ACTOR:
    {
      ...
      csRef<CS::Collisions::iColliderSphere> sphere = collisionSystem->CreateColliderSphere (ActorDimensions.x);
