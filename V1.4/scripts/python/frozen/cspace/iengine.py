...
def iFrustumViewUserdata_scfGetVersion():
  return _iengine.iFrustumViewUserdata_scfGetVersion()
...
class csFrustumContext(object):
    ...
    __repr__ = _swig_repr
    def __init__(self): 
        this = _iengine.new_csFrustumContext()
        try: self.this.append(this)
        except: self.this = this
    def assign(self, *args): return _iengine.csFrustumContext_assign(self, *args)
    def GetShadows(self): return _iengine.csFrustumContext_GetShadows(self)
    def SetShadows(self, *args): return _iengine.csFrustumContext_SetShadows(self, *args)
    def SetNewShadows(self, *args): return _iengine.csFrustumContext_SetNewShadows(self, *args)
    def IsShared(self): return _iengine.csFrustumContext_IsShared(self)
    def SetLightFrustum(self, *args): return _iengine.csFrustumContext_SetLightFrustum(self, *args)
    def SetNewLightFrustum(self, *args): return _iengine.csFrustumContext_SetNewLightFrustum(self, *args)
    def GetLightFrustum(self): return _iengine.csFrustumContext_GetLightFrustum(self)
    def SetMirrored(self, *args): return _iengine.csFrustumContext_SetMirrored(self, *args)
    def IsMirrored(self): return _iengine.csFrustumContext_IsMirrored(self)
...
class iFrustumView(core.iBase):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    def GetFrustumContext(self): return _iengine.iFrustumView_GetFrustumContext(self)
    def CreateFrustumContext(self): return _iengine.iFrustumView_CreateFrustumContext(self)
    def CopyFrustumContext(self): return _iengine.iFrustumView_CopyFrustumContext(self)
    def SetFrustumContext(self, *args): return _iengine.iFrustumView_SetFrustumContext(self, *args)
    def RestoreFrustumContext(self, *args): return _iengine.iFrustumView_RestoreFrustumContext(self, *args)
    def SetObjectFunction(self, *args): return _iengine.iFrustumView_SetObjectFunction(self, *args)
    def CallObjectFunction(self, *args): return _iengine.iFrustumView_CallObjectFunction(self, *args)
    def GetRadius(self): return _iengine.iFrustumView_GetRadius(self)
    def GetSquaredRadius(self): return _iengine.iFrustumView_GetSquaredRadius(self)
    def CheckShadowMask(self, *args): return _iengine.iFrustumView_CheckShadowMask(self, *args)
    def CheckProcessMask(self, *args): return _iengine.iFrustumView_CheckProcessMask(self, *args)
    def StartNewShadowBlock(self): return _iengine.iFrustumView_StartNewShadowBlock(self)
    def SetUserdata(self, *args): return _iengine.iFrustumView_SetUserdata(self, *args)
    def GetUserdata(self): return _iengine.iFrustumView_GetUserdata(self)
...
def iFrustumView_scfGetVersion():
  return _iengine.iFrustumView_scfGetVersion()
...
class iLight(core.iBase):
    ...
    def AddAffectedLightingInfo(self, *args): return _iengine.iLight_AddAffectedLightingInfo(self, *args)
    def RemoveAffectedLightingInfo(self, *args): return _iengine.iLight_RemoveAffectedLightingInfo(self, *args)
    def Setup(self): return _iengine.iLight_Setup(self)
...
class iLightingProcessData(core.iBase):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    def FinalizeLighting(self): return _iengine.iLightingProcessData_FinalizeLighting(self)
...
class iLightingProcessInfo(iFrustumViewUserdata):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    def GetLight(self): return _iengine.iLightingProcessInfo_GetLight(self)
    def IsDynamic(self): return _iengine.iLightingProcessInfo_IsDynamic(self)
    def SetColor(self, *args): return _iengine.iLightingProcessInfo_SetColor(self, *args)
    def GetColor(self): return _iengine.iLightingProcessInfo_GetColor(self)
    def AttachUserdata(self, *args): return _iengine.iLightingProcessInfo_AttachUserdata(self, *args)
    def QueryUserdata(self, *args): return _iengine.iLightingProcessInfo_QueryUserdata(self, *args)
    def FinalizeLighting(self): return _iengine.iLightingProcessInfo_FinalizeLighting(self)
...
class iSector(core.iBase):
    ...
    def ShineLights(self, *args): return _iengine.iSector_ShineLights(self, *args)
    ...
    def CheckFrustum(self, *args): return _iengine.iSector_CheckFrustum(self, *args)
...
class iEngine(core.iBase):
    ...
    def ForceRelight(self, *args): return _iengine.iEngine_ForceRelight(self, *args)
    def ShineLights(self, base = None, meter = None): return _iengine.iEngine_ShineLights(self, base, meter)
    def SetLightingCacheMode(self, *args): return _iengine.iEngine_SetLightingCacheMode(self, *args)
    def GetLightingCacheMode(self): return _iengine.iEngine_GetLightingCacheMode(self)
    ...
    def SetMaxLightmapSize(self, *args): return _iengine.iEngine_SetMaxLightmapSize(self, *args)
    def GetMaxLightmapSize(self): return _iengine.iEngine_GetMaxLightmapSize(self)
    def GetDefaultMaxLightmapSize(self): return _iengine.iEngine_GetDefaultMaxLightmapSize(self)
    def GetMaxLightmapAspectRatio(self): return _iengine.iEngine_GetMaxLightmapAspectRatio(self)
    ...
    def FindMaterialRegion(self, *args): return _iengine.iEngine_FindMaterialRegion(self, *args)
    def FindMaterialCollection(self, *args): return _iengine.iEngine_FindMaterialCollection(self, *args)
    ...
    def FindTextureRegion(self, *args): return _iengine.iEngine_FindTextureRegion(self, *args)
    def FindTextureCollection(self, *args): return _iengine.iEngine_FindTextureCollection(self, *args)
    ...
    def GetLightIterator(self, base = None): return _iengine.iEngine_GetLightIterator(self, base)
    def GetLightIteratorRegion(self, *args): return _iengine.iEngine_GetLightIteratorRegion(self, *args)
    def GetLightIteratorCollection(self, collection = None): return _iengine.iEngine_GetLightIteratorCollection(self, collection)
    ...
    def FindSectorRegion(self, *args): return _iengine.iEngine_FindSectorRegion(self, *args)
    def FindSectorCollection(self, *args): return _iengine.iEngine_FindSectorCollection(self, *args)
    ...
    def CreateSectorWallsMesh(self, *args): return _iengine.iEngine_CreateSectorWallsMesh(self, *args)
    def CreateThingMesh(self, *args): return _iengine.iEngine_CreateThingMesh(self, *args)
    ...
    def FindMeshObjectRegion(self, *args): return _iengine.iEngine_FindMeshObjectRegion(self, *args)
    def FindMeshObjectCollection(self, *args): return _iengine.iEngine_FindMeshObjectCollection(self, *args)
    ...
    def FindMeshFactoryRegion(self, *args): return _iengine.iEngine_FindMeshFactoryRegion(self, *args)
    def FindMeshFactoryCollection(self, *args): return _iengine.iEngine_FindMeshFactoryCollection(self, *args)
    def GetMeshFactories(self): return _iengine.iEngine_GetMeshFactories(self)
    def CreateRegion(self, *args): return _iengine.iEngine_CreateRegion(self, *args)
    def GetRegions(self): return _iengine.iEngine_GetRegions(self)
    ...
    def FindCameraPositionRegion(self, *args): return _iengine.iEngine_FindCameraPositionRegion(self, *args)
    def FindCameraPositionCollection(self, *args): return _iengine.iEngine_FindCameraPositionCollection(self, *args)
    ...
    def PrecacheDraw(self, base = None): return _iengine.iEngine_PrecacheDraw(self, base)
    def PrecacheDrawCollection(self, collection = None): return _iengine.iEngine_PrecacheDrawCollection(self, collection)
    def PrecacheDrawRegion(self, *args): return _iengine.iEngine_PrecacheDrawRegion(self, *args)
    ...
    def CreateLoaderContext(self, base = None, curRegOnly = True): return _iengine.iEngine_CreateLoaderContext(self, base, curRegOnly)
    ...
    def CreateFrustumView(self): return _iengine.iEngine_CreateFrustumView(self)
...
class iMeshWrapper(core.iBase):
    ...
    def GetLightingInfo(self): return _iengine.iMeshWrapper_GetLightingInfo(self)
    def GetShadowReceiver(self): return _iengine.iMeshWrapper_GetShadowReceiver(self)
    def GetShadowCaster(self): return _iengine.iMeshWrapper_GetShadowCaster(self)
    ...
    def SetLightingUpdate(self, *args): return _iengine.iMeshWrapper_SetLightingUpdate(self, *args)
    ...
    def GetExtraRenderMeshPriority(self, *args): return _iengine.iMeshWrapper_GetExtraRenderMeshPriority(self, *args)
...
class iRegion(core.iBase):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    def QueryObject(self): return _iengine.iRegion_QueryObject(self)
    def Add(self, *args): return _iengine.iRegion_Add(self, *args)
    def Remove(self, *args): return _iengine.iRegion_Remove(self, *args)
    def Clear(self): return _iengine.iRegion_Clear(self)
    def DeleteAll(self): return _iengine.iRegion_DeleteAll(self)
    def PrepareTextures(self): return _iengine.iRegion_PrepareTextures(self)
    def ShineLights(self): return _iengine.iRegion_ShineLights(self)
    def Prepare(self): return _iengine.iRegion_Prepare(self)
    def FindSector(self, *args): return _iengine.iRegion_FindSector(self, *args)
    def FindMeshObject(self, *args): return _iengine.iRegion_FindMeshObject(self, *args)
    def FindMeshFactory(self, *args): return _iengine.iRegion_FindMeshFactory(self, *args)
    def FindTexture(self, *args): return _iengine.iRegion_FindTexture(self, *args)
    def FindMaterial(self, *args): return _iengine.iRegion_FindMaterial(self, *args)
    def FindShader(self, *args): return _iengine.iRegion_FindShader(self, *args)
    def FindCameraPosition(self, *args): return _iengine.iRegion_FindCameraPosition(self, *args)
    def IsInRegion(self, *args): return _iengine.iRegion_IsInRegion(self, *args)
...
class iRegionList(core.iBase):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    def GetCount(self): return _iengine.iRegionList_GetCount(self)
    def Get(self, *args): return _iengine.iRegionList_Get(self, *args)
    def Add(self, *args): return _iengine.iRegionList_Add(self, *args)
    def Remove(self, *args): return _iengine.iRegionList_Remove(self, *args)
    def RemoveAll(self): return _iengine.iRegionList_RemoveAll(self)
    def Find(self, *args): return _iengine.iRegionList_Find(self, *args)
    def FindByName(self, *args): return _iengine.iRegionList_FindByName(self, *args)
    def __delitem__(self, *args): return _iengine.iRegionList___delitem__(self, *args)
    def __len__(self): return _iengine.iRegionList___len__(self)
    def append(self, *args): return _iengine.iRegionList_append(self, *args)
    def content_iterator(self):
            for idx in xrange(len(self)):
                    yield self.__getitem__(idx)
    def __iter__(self): return self.content_iterator()  
    def __getitem__(self, *args): return _iengine.iRegionList___getitem__(self, *args)
    def __contains__(self, *args): return _iengine.iRegionList___contains__(self, *args)
...
class iVisibilityCuller(core.iBase):
    ...
    def CastShadows(self, *args): return _iengine.iVisibilityCuller_CastShadows(self, *args)
...
class iPortal(core.iBase):
    ...
    def CheckFrustum(self, *args): return _iengine.iPortal_CheckFrustum(self, *args)
