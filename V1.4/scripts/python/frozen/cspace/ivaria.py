...
class csCollisionPairArrayChangeElements(csCollisionPairArrayReadOnly):
    ...
    def Top(self): return _ivaria.csCollisionPairArrayChangeElements_Top(self)
...
class iSequenceWrapper(core.iBase):
    ...
    def AddOperationSetPolygonMaterial(self, *args): return _ivaria.iSequenceWrapper_AddOperationSetPolygonMaterial(self, *args)
